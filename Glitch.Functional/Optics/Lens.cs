...
namespace Glitch.Functional.Optics
{
    ...
    {
        /// <summary>
        /// <inheritdoc cref="Lens{TFocus, TValue}.New(Func{TFocus, TValue}, Func{TFocus, TValue, TFocus})"/>
        /// </summary>
        ...
        /// <summary>
        /// <inheritdoc cref="Lens{TFocus, TValue}.New(Func{TFocus, TValue}, Func{TFocus, TValue, TValue, TFocus})"/>
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="get"></param>
        /// <param name="set"></param>
