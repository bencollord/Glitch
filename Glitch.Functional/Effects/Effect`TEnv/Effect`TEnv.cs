...
/// A combination of the Try and Reader monads.
/// </summary>
...
public partial class Effect<TEnv, T>
{
    ...
    public static Effect<TEnv, T> Return<E>(Result<T, E> result) where E : Error => new(_ => result.SelectError(StaticCast<Error>.UpFrom));
