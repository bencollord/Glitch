...
namespace Glitch.Functional.Parsing
{
    ...
    {
        private readonly Func<TokenSequence<TToken>, ParseResult<TToken, T>> parser;
        ...
        public virtual Parser<TToken, IEnumerable<T>> SeparatedBy<TSeparator>(Parser<TToken, TSeparator> separator)
            => 
