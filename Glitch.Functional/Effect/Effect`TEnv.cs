...
namespace Glitch.Functional
{
    ...
    public partial class Effect<TInput, T>
    {
        ...
        /// <returns></returns>
        public Effect<TInput, TResult> Map<TResult>(Func<T, TResult> map)
            => new(i => thunk(i).Map(map));

        public Effect<TInput, Func<T2, TResult>> PartialMap<T2, TResult>(Func<T, T2, TResult> map)
            => Map(map.Curry());
        ...
        /// <param name="map"></param>
        /// <returns></returns>
        public Effect<TInput, T> MapError(Func<Error, Error> map)
            => new(i => thunk(i).MapError(map));

        public Effect<TInput, T> MapError<TError>(Func<TError, Error> map)
            where TError : Error
            => MapError(err => err is TError e ? map(e) : err);

        public Effect<TInput, T> Catch<TException>(Func<TException, T> map)
            where TException : Exception
            => OrElse(err => err.IsException<TException>() ? map((TException)err.AsException()) : err);

        public Effect<TInput, T> Catch<TException>(Func<TException, Error> map)
            where TException : Exception
        ...
        /// <returns></returns>
        public Effect<TInput, TResult> Apply<TResult>(Effect<TInput, Func<T, TResult>> function)
            => AndThen(v => function.Map(fn => fn(v)));

        /// <summary>
        /// Returns other if Okay, otherwise returns the current error wrapped
        /// in a new <see cref="Effect{TInput, TResult}">effect type.</see>
        /// </summary>
        /// <typeparam name="TResult"></typeparam>
        /// <param name="other"></param>
        /// <returns></returns>
        public Effect<TInput, TResult> Then<TResult>(Effect<TInput, TResult> other)
            => new(i =>
            {
                var result = thunk(i);
        ...
        /// error wrapped in a new <see cref="Effect{TInput, TResult}">effect type.</see>
        /// </summary>
        /// <typeparam name="TOther"></typeparam>
        /// <typeparam name="TResult"></typeparam>
        /// <param name="other"></param>
        /// <returns></returns>
        public Effect<TInput, TResult> Then<TOther, TResult>(Effect<TInput, TOther> other, Func<T, TOther, TResult> projection)
        ...
        /// <returns></returns>
        public Effect<TInput, TResult> AndThen<TResult>(Func<T, Effect<TInput, TResult>> bind)
            => new(i =>
            {
                var result = thunk(i);
        ...
        /// <returns></returns>
        public Effect<TInput, TResult> AndThen<TElement, TResult>(Func<T, Effect<TInput, TElement>> bind, Func<T, TElement, TResult> project)
        ...
        /// <param name="project"></param>
        /// <returns></returns>
        public Effect<TInput, TResult> AndThen<TElement, TResult>(Func<T, Result<TElement>> bind, Func<T, TElement, TResult> project)
            => AndThen(x => bind(x).Map(y => project(x, y)));

        public Effect<TInput, TResult> Choose<TResult>(Func<T, Effect<TInput, TResult>> okay, Func<Error, Effect<TInput, TResult>> error)
        ...
        /// <param name="bind"></param>
        /// <returns></returns>
        public Effect<TInput, TResult> AndThen<TResult>(Func<T, Effect<TResult>> bind)
        ...
        /// <param name="project"></param>
        /// <returns></returns>
        public Effect<TInput, TResult> AndThen<TElement, TResult>(Func<T, Effect<TElement>> bind, Func<T, TElement, TResult> project)
            => AndThen(x => bind(x).Map(y => project(x, y)));
        ...
        /// <param name="other"></param>
        /// <returns></returns>
        public Effect<TInput, T> Or(Effect<TInput, T> other)
            => new(i =>
            {
                var result = thunk(i);
        ...
        /// <param name="other"></param>
        /// <returns></returns>
        public Effect<TInput, T> OrElse(Func<Error, Effect<TInput, T>> other)
            => new(i =>
            {
                var result = thunk(i);
        ...
        /// <returns></returns>
        public Effect<TInput, T> Do(Action<T> action) => IfOkay(action); // TODO Not sure how I feel about just aliasing methods like this.
        ...
        /// <param name="action"></param>
        /// <returns></returns>
        public Effect<TInput, T> IfOkay(Action<T> action) => new(i => thunk(i).Do(action));
        ...
        /// <param name="other"></param>
        /// <returns></returns>
        public Effect<TInput, (T, TOther)> Zip<TOther>(Effect<TInput, TOther> other)
            => Zip(other, (x, y) => (x, y));
        ...
        /// <returns></returns>
        public Effect<TInput, TResult> Zip<TOther, TResult>(Effect<TInput, TOther> other, Func<T, TOther, TResult> zipper)
            => new(i => thunk(i).Zip(other.thunk(i), zipper));

        public Effect<T> Apply(TInput input) => Effect<T>.Lift(() => Run(input));
        ...
        /// <returns></returns>
        public Effect<TInput, TResult> Match<TResult>(Func<T, TResult> okay, TResult error)
            => Match(okay, _ => error);
        ...
        /// </summary>
        /// <returns></returns>
        public Result<T> Run(TInput input)
        {
            try
            {
        ...
        public static implicit operator Effect<TInput, T>(Effect<T> effect) => effect.WithInput<TInput>();
        ...
        public static Effect<TInput, T> operator >>(Effect<TInput, T> x, Effect<TInput, T> y)
            => x.Then(y);

        public static Effect<TInput, T> operator >>(Effect<TInput, T> x, Effect<T> y)
            => x.AndThen(_ => Lift(y));

        public static Effect<TInput, T> operator >>(Effect<TInput, T> x, Effect<TInput, Nothing> y)
            => x.AndThen(v => y.Map(_ => v));

        public static Effect<TInput, T> operator >>(Effect<TInput, T> x, Effect<Nothing> y)
        ...
        public static Effect<TInput, T> operator >>(Effect<TInput, T> x, Func<T> y)
            => new(i =>
            {
                _ = x.thunk(i);
