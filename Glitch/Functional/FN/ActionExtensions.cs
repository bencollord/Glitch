namespace Glitch.Functional
{
    ...
    {
        public static Func<Terminal> Return(this Action action) 
            => action.Return(Terminal.Value);
        ...
        public static Func<T, Terminal> Return<T>(this Action<T> action)
            => action.Return(Terminal.Value);
        ...
        public static Func<T1, T2, Terminal> Return<T1, T2>(this Action<T1, T2> action)
            => action.Return(Terminal.Value);
        ...
        public static Func<T1, T2, T3, Terminal> Return<T1, T2, T3>(this Action<T1, T2, T3> action)
            => action.Return(Terminal.Value);
        ...
        public static Func<T1, T2, T3, T4, Terminal> Return<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> action)
            => action.Return(Terminal.Value);
        ...
        public static Func<T1, T2, T3, T4, T5, Terminal> Return<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> action)
            => action.Return(Terminal.Value);
