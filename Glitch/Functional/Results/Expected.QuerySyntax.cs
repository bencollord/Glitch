...
namespace Glitch.Functional.Results
{
    ...
    {
        public static Expected<TResult, E> Select<T, E, TResult>(this Expected<T, E> source, Func<T, TResult> mapper)
            => source.Map(mapper);
        ...
        public static Expected<TResult, E> SelectMany<T, E, TElement, TResult>(this Expected<T, E> source, Func<T, Success<TElement>> bind, Func<T, TElement, TResult> bindMap)
            => source.AndThen(s => (Expected<TResult, E>)bind(s).Map(e => bindMap(s, e)));
