...
namespace Glitch.Functional.Results
{
    ...
    public static partial class Option
    {
        ...
        public static Option<Expected<TResult, E>> AndThen<T, E, TElement, TResult>(this Option<Expected<T, E>> option, Func<T, Option<TElement>> bind, Func<T, TElement, TResult> project)
            => option.AndThen((Func<Expected<T, E>, Option<Expected<TResult, E>>>)(res => res.Match(okay: (Func<T, Option<Expected<TResult, E>>>)(v => Option.Select<TElement, E, TResult>(bind(v).Select(Okay<TElement, E>), project.Curry()(v))),
        ...
        public static Option<Expected<TResult, E>> AndThen<T, E, TElement, TResult>(this Option<Expected<T, E>> option, Func<T, Expected<TElement, E>> bind, Func<T, TElement, TResult> project)
            => option.AndThen((Func<Expected<T, E>, Option<Expected<TResult, E>>>)(res => res.Match(okay: (Func<T, Option<Expected<TResult, E>>>)(v => Option.Select<TElement, E, TResult>(Some(bind(v)), project.Curry()(v))),
        ...
        public static Option<Expected<TResult, E>> AndThen<T, E, TElement, TResult>(this Option<Expected<T, E>> option, Func<T, Option<Expected<TElement, E>>> bind, Func<T, TElement, TResult> project)
            => option.AndThen((Func<Expected<T, E>, Option<Expected<TResult, E>>>)(res => res.Match(okay: (Func<T, Option<Expected<TResult, E>>>)(v => Option.Select<TElement, E, TResult>(bind(v), project.Curry()(v))),
                                               error: e => Some(Fail<TResult, E>(e)))));
